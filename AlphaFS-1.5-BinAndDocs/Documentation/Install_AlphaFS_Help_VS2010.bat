...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "AlphaFS" /productName "AlphaFS" > NUL
...
COPY /Y "AlphaFS.msha" HelpContentSetup.msha
